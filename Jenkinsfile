/**
 * This file is to implement the CVP testing of rhel7/support-tools in the "extras" way.
        ...
        script {
          ...
          try {
            sh """
               ...
               ansible-playbook support_tools.yml -e image_fullname=${img_fn}
            """
          }
          catch (exc) {
            result_flag = 1
      ...
      post {
        always {
          script {
            ...
            def namespace = "atomic-support-tools-rhel7-container-test"
            def type = "default"
