/**
 * This file is to implement the CVP testing of rhel7/flannel in the "extras" way.
        ...
        script {
          ...
          try {
            sh """
               ...
               ansible-playbook flannel.yml -e image_fullname=${img_fn}
            """
          }
          catch (exc) {
            result_flag = 1
      ...
      post {
        always {
          script {
            ...
            def namespace = "atomic-flannel-rhel7-container-test"
            def type = "default"
