/**
 * This file is to implement the CVP testing of ubi8-init-container in the "extras" way.
        ...
        script {
          ...
          try {
            sh """
               ...
               ansible-playbook ubi_init.yml -e image_fullname=${img_fn}
            """
          }
          catch (exc) {
            result_flag = 1
      ...
      post {
        always {
          script {
            ...
            def namespace = "atomic-init-ubi8-container-test"
            def type = "default"
