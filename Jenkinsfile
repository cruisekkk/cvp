/**
 * This file is to implement the CVP testing of rhel8/net-snmp in the "extras" way.
        ...
        script {
          ...
          try {
            sh """
               ...
               ansible-playbook net_snmp.yml -e image_fullname=${img_fn}
            """
          }
          catch (exc) {
            result_flag = 1
      ...
      post {
        always {
          script {
            ...
            def namespace = "atomic-net-snmp-rhel8-container-test"
            def type = "default"
