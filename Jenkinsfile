/**
 * This file is to implement the CVP testing of rhel7/sadc in the "extras" way.
        ...
        script {
          ...
          try {
            sh """
               ...
               ansible-playbook sadc.yml -e image_version=/${dmg_ns}/${img_name}:${img_tag}
            """
          }
          catch (exc) {
            result_flag = 1
      ...
      post {
        always {
          script {
            ...
            def namespace = "atomic-sadc-rhel7-container-test"
            def type = "default"
